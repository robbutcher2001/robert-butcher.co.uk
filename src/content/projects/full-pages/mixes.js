module.exports = {
  title: 'Rob\'s Recorded Mixes',
  logoUrl: '/content/images/mixer.jpg',
  logoLink: '/projects/mixes',
  proseA: [
    'As you may have already gathered, Rob has always loved his music. This love extended into manipulating music and eventually mixing it together during his first year of University when he started to experiment with mixing software.',
  ...
  proseB: [
    ...
    'He\'d frequented this club a fair few times between 18 and 21 so to be behind the decks and playing a set to the crowd he used to be in was something quite special. Drum and bass was big at the time so even though it\'s not his music of choice, he had so much fun playing the following set to a crowd of a few hundred:'
  ],
  mixB: 'https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1&feed=%2Frobbutcher%2Fcommercial-zen-mix%2F',
  proseC: [
    '',
